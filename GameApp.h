...
public:
	...
	enum class ShowMode { WoodCrate, FireAnim, Texture};
...
private:
	...
	ComPtr<ID3D11ShaderResourceView> m_pTexture1;			    // 纹理1
	ComPtr<ID3D11ShaderResourceView> m_pTexture2;			    // 纹理2
	ComPtr<ID3D11ShaderResourceView> m_pTexture3;			    // 纹理3
	ComPtr<ID3D11ShaderResourceView> m_pTexture4;			    // 纹理4
	ComPtr<ID3D11ShaderResourceView> m_pTexture5;			    // 纹理5
	ComPtr<ID3D11ShaderResourceView> m_pTexture6;			    // 纹理6
